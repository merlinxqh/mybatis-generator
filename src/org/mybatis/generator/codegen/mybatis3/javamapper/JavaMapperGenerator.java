...
import org.mybatis.generator.ext.SelectByCountMethodGenerator;
import org.mybatis.generator.ext.SelectByPageMethodGenerator;
import org.mybatis.generator.ext.SelectByParamsMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        //增加baseMapper
        /*FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType(
                "com.facegarden.base.common.dao.CrudMapper");
...
//        addSelectByPrimaryKeyMethod(interfaze);
        ...
        //新增查询
//        addSelectByParamsMethod(interfaze);
        //新增分页查询
...
//        addUpdateByPrimaryKeyWithoutBLOBsMethod(interfaze);
        ...
        //add mapper
        //默认引入类
        String basemapper = "com.facegarden.base.common.dao.CrudMapper";
        JavaClientGeneratorConfiguration config = context.getJavaClientGeneratorConfiguration();
		if (StringUtility.stringHasValue(config.getInterfaceExtendSupInterface())) {
			basemapper = config.getInterfaceExtendSupInterface();
		}
		//引入泛型实体类
		/*FullyQualifiedJavaType fqjt = new FullyQualifiedJavaType(introspectedTable.getBaseRecordType());
		interfaze.addImportedType(fqjt);*/
		//接口
		FullyQualifiedJavaType inter = new FullyQualifiedJavaType(basemapper);
		//inter.addTypeArgument(fqjt);
		interfaze.addSuperInterface(inter);
		interfaze.addImportedType(inter);
        
		//增加扫描注解
		String mapperScanAnnotation = "com.facegarden.base.common.annotation.MyBatisDao";
		if (StringUtility.stringHasValue(config.getMapperScanAnnotation())) {
			mapperScanAnnotation = config.getMapperScanAnnotation();
		}
		interfaze.addImportedType(new FullyQualifiedJavaType(mapperScanAnnotation));
        interfaze.addAnnotation("@" + StringUtility.getEntityClassName(mapperScanAnnotation));
    ...
    //update huangtao
    protected void addSelectByParamsMethod(Interface interfaze) {
    	//TODO 初始化
    	AbstractJavaMapperMethodGenerator methodGenerator = new SelectByParamsMethodGenerator();
    	initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
    
    protected void addSelectCountMethod(Interface interfaze) {
    	//TODO 初始化
    	AbstractJavaMapperMethodGenerator methodGenerator = new SelectByCountMethodGenerator();
    	initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
