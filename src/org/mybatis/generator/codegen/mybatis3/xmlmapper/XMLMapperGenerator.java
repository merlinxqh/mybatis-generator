...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.DeleteByPrimaryKeyForModelElementGenerator;
...
import org.mybatis.generator.ext.ConditionElementGenerator;
import org.mybatis.generator.ext.SelectByCountElementGenerator;
import org.mybatis.generator.ext.SelectByPageElementGenerator;
import org.mybatis.generator.ext.SelectByParamsElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectByCountElement(answer);
        addSelectByPageElement(answer);
        
        addDeleteByPrimaryKeyElement(answer);
        addDeleteByPrimaryKeyForModelElement(answer);
    ...
    protected void addSelectByCountElement(XmlElement parentElement) {
    	AbstractXmlElementGenerator elementGenerator = new SelectByCountElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    ...
    protected void addDeleteByPrimaryKeyForModelElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateDeleteByPrimaryKey()) {
            AbstractXmlElementGenerator elementGenerator = new DeleteByPrimaryKeyForModelElementGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
