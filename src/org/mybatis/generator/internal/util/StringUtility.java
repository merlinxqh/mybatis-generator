...
public class StringUtility {
    ...
    /**
     * 通过全类名获取  ==> 类名
     * @param className  "org.mybatis.generator.internal.util.StringUtility"
    ...
    public static void main(String[] args) {
    	System.out.println(getEntityClassName("org.mybatis.generator.internal.util.StringUtility"));
    }
}
