...
public class FullyQualifiedTable {
    ...
    private Map<String, String> replaceTablePrefixMap;
	...
	public String getYouGouFullyQualifiedTableNameAtRuntime() {
		...
		if (!this.ignoreQualifiersAtRuntime) {
			if (stringHasValue(this.runtimeCatalog)) {
				localCatalog.append(this.runtimeCatalog);
			} else if (stringHasValue(this.introspectedCatalog)) {
		...
		StringBuilder localSchema = new StringBuilder();
		if (!this.ignoreQualifiersAtRuntime) {
			if (stringHasValue(this.runtimeSchema)) {
				localSchema.append(this.runtimeSchema);
			} else if (stringHasValue(this.introspectedSchema)) {
		...
		return composeFullyQualifiedTableName(localCatalog.toString(),
