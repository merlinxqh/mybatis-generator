...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        /** The attr delete by primary key statement id. */
        ATTR_DELETE_BY_PRIMARY_KEY_FOR_MODEL_STATEMENT_ID,
        ...
        /** The attr select by params statement id */
        ATTR_SELECT_BY_PARAMS_STATEMENT_ID,
        
        ATTR_SELECT_BY_COUNT_STATEMENT_ID,
        
        ATTR_SELECT_BY_PAGE_STATEMENT_ID,
        
        ATTR_CONDITION_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setDeleteByPrimaryKeyForModelStatementId("deleteByPrimarayKeyForModel"); 
        ...
        //add huangtao
        setSelectByParamsStatementId("selectByParams");
        //noted by zhugj,remove selectCount statement.
        setSelectByCountStatementId("selectCount");
        setSelectByPageStatementId("selectByPage");
        setConditionStatementId("condition");
    ...
    //update huangtao
    public void setSelectByParamsStatementId(String s) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_SELECT_BY_PARAMS_STATEMENT_ID, s);
    }
    
    public void setSelectByCountStatementId(String s) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_SELECT_BY_COUNT_STATEMENT_ID, s);
    }
    
    public void setSelectByPageStatementId(String s) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_SELECT_BY_PAGE_STATEMENT_ID, s);
    }
    
    public void setConditionStatementId(String s) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_CONDITION_STATEMENT_ID, s);
    }
    ...
    public void setDeleteByPrimaryKeyForModelStatementId(String s) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_DELETE_BY_PRIMARY_KEY_FOR_MODEL_STATEMENT_ID, s);
    }
    ...
    //add huangtao
    public String getSelectByParamsStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_SELECT_BY_PARAMS_STATEMENT_ID);
    }
    
    public String getSelectByCountStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_SELECT_BY_COUNT_STATEMENT_ID);
    }
    
    public String getSelectByPageStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_SELECT_BY_PAGE_STATEMENT_ID);
    }
    
    public String getConditionStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_CONDITION_STATEMENT_ID);
    }
    ...
    public String getDeleteByPrimaryKeyForModelStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_DELETE_BY_PRIMARY_KEY_FOR_MODEL_STATEMENT_ID);
    }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.setLength(0);
        sb.append(calculateJavaManagerInterfacePackage());
        sb.append('.');
        sb.append(this.fullyQualifiedTable.getDomainObjectName());
        sb.append("Manager");
        ...
        sb.append(".");
        sb.append(this.fullyQualifiedTable.getDomainObjectName());
        sb.append("ManagerImpl");
        setMyBatis3JavaManagerImplType(sb.toString());
	...
	public String getMyBatis3JavaServiceType() {
		return (String) this.internalAttributes
	...
	public void setMyBatis3JavaControllerInstanceName(
			String mybatis3JavaControllerIntanceName) {
		this.internalAttributes.put(
