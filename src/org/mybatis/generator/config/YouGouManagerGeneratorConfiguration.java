...
public class YouGouManagerGeneratorConfiguration extends TypedPropertyHolder {
	...
	public void setExtendSupClassDoMain(String extendSupClassDoMain) {
		this.extendSupClassDoMain = extendSupClassDoMain;
	}
	...
	public XmlElement toXmlElement() {
		XmlElement answer = new XmlElement("javaManagerGenerator");
