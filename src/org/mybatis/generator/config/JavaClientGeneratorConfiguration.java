...
public class JavaClientGeneratorConfiguration extends TypedPropertyHolder {
     ...
     * 扫描注解 
     */
    private String mapperScanAnnotation;
	...
	public String getMapperScanAnnotation() {
		return mapperScanAnnotation;
	}

	public void setMapperScanAnnotation(String mapperScanAnnotation) {
		this.mapperScanAnnotation = mapperScanAnnotation;
	}
    ...
    public XmlElement toXmlElement() {
        ...
        if (interfaceExtendSupInterface != null) {
			answer.addAttribute(new Attribute("interfaceExtendSupInterface", 
					interfaceExtendSupInterface));
		}
        if (mapperScanAnnotation != null) {
			answer.addAttribute(new Attribute("mapperScanAnnotation",
