...
public class YouGouServiceGeneratorConfiguration extends TypedPropertyHolder {
	...
	public void setInterfaceExtendSupInterfaceDoMain(
			String interFaceExtendSupInterfaceDoMain) {
