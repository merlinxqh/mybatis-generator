...
public class Tools {
	...
	public static String formatRelativePath(String linkPath, String relativePath)
			throws Exception {
		if ((linkPath == null) || (relativePath == null)
				|| ("".equals(relativePath.trim()))) {
			return linkPath;
		}
		if (linkPath.substring(linkPath.length() - 1, linkPath.length())
